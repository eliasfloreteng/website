    ...
    <div className="relative flex w-full items-center justify-center bg-gray-950 p-8">
      {isScrollable && (
        <>
          <button
            onClick={scrollLeft}
            className="absolute left-4 z-20 rounded-full bg-gray-800/50 p-3 text-white transition-opacity duration-500 hover:bg-gray-800/75"
          ...
          <button
            onClick={scrollRight}
            className="absolute right-4 z-20 rounded-full bg-gray-800/50 p-3 text-white transition-opacity duration-500 hover:bg-gray-800/75"
      ...
      <div
        className="pointer-events-none absolute right-0 top-0 z-10 h-full w-1/5 bg-gradient-to-l from-gray-950 to-transparent transition-opacity duration-500"
        style={{ opacity: rightGradientOpacity }}
      />
      <div
        className="pointer-events-none absolute left-0 top-0 z-10 h-full w-1/5 bg-gradient-to-r from-gray-950 to-transparent transition-opacity duration-500"
        style={{ opacity: leftGradientOpacity }}
      />

      <div
        ref={scrollContainerRef}
        className="flex space-x-6 overflow-x-auto pb-8"
      >
